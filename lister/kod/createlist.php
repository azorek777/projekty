...
<head>
    ...
    <title>Lister - Dodaj listę!</title>
</head>
<?php
...
<body onload="changeNav()">
    <header>
        ...
        <nav>
            ...
            <a id="createListNav" href="createlist.php" class="chosen">CREATE LIST</a>
    ...
    <main>
        <article class="login_article">
            ...
            <form method="post" action="addlist.php">
                ...
                <h3>Typ listy: </h3>
                <div class="sex">
                    <label>Publiczna</label><input type="radio" name="type" value="public" required>
                    <label>Prywatna</label><input type="radio" name="type" value="private" required>
                </div><br>
                ...
                <h3>Podaj tytuły po przecinku:</h3>
                <textarea name="content" required></textarea><br>
                <p>Nie ma tego, czego szukasz? <a href="createcontent.php">Dodaj!</a></p>
                <button type="submit" name="submit">Dodaj listę!</button>
            </form>
        </article>
    </main>
    <footer>
        <div class="footer_content">
            <nav class="footer_nav">
                ...
                <a id="createListNavBottom" href="createlist.php" class="chosen">Create List</a>
