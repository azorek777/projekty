...
<?php
   ...
   ";
?>  
<body onload="changeNav(), changeMain(), accountHref()">
    <header>
    ...
    <main id="main">
        <article class="main_article">
            <img src="img/back_pic.png" alt="presentation image">
            <h1 class="mainText">
                List everything you want.<br>
                Share it with community.<br>
                Have everything organized.
            </h1>
            <a href="register.php"><button type="button">GET STARTED!</button></a>
            <p class="note">A place with every list you might look for! App coming soon.<img class="android" src="img/android.svg" alt="android logo"></p>
        </article>
        <article class="blocks_article">
            <p class="blocks_title">LISTER LETS YOU...</p>
            <div class="card-layout">
                <div class="card-layout__item">
                    <img src="img/list.svg" alt="icon">
                    <p>Organize all your plans with list on any topic</p>
                </div>
                <div class="card-layout__item">
                    <img src="img/eye.svg" alt="icon">
                    <p>Check what's popular nowadays</p>
                </div>
                <div class="card-layout__item">
                    <img src="img/book.svg" alt="icon">
                    <p>Put all your lectures to read in college in a simple list</p>
                </div>
                <div class="card-layout__item">
                    <img src="img/movie.svg" alt="icon">
                    <p>Plan a meeting with friends sharing a list what to watch</p>
                </div>
                <div class="card-layout__item">
                    <img src="img/heart.svg" alt="icon">
                    <p>Follow community members and their lists</p>
                </div>
                <div class="card-layout__item">
                    <img src="img/star.svg" alt="icon">
                    <p>Share your well-made list with community</p>
                </div>
            </div>
     </article>
    </main>
    <main id="list_main_index" class="list_main">
